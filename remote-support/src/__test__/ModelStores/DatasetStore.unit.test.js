...
describe("DatasetStore test", () => {
  ...
  test("replacing and clearing an array", () => {
    ...
    expect(rootstore.datasetStore.measurements[0].Name).toStrictEqual(
      "NomeM015"
    );
    ...
    expect(rootstore.datasetStore.measurements[1].Name).toStrictEqual(
      "NomeM014"
    );
    ...
    expect(rootstore.datasetStore.measurements[2].Name).toStrictEqual(
      "NomeM045"
    );
    ...
    expect(rootstore.datasetStore.measurements[3].Name).toStrictEqual(
      "NomeM038"
    );
