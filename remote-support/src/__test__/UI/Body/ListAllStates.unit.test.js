...
import ListAllStates from "../../../UI/Body/DataArea/StatesArea/ListAllStates";
...
describe ("ListAllAlarms correct render", () => {
    ...
    test("Alarms Area correct render", () => {
        ...
        render(<ListAllStates vars={vars} />);
        expect(document.getElementsByClassName("active-item")[0] && document.getElementsByClassName("not-active-item")[0]).toBeInTheDocument();
    });
});
